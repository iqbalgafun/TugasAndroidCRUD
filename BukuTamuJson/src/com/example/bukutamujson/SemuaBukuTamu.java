...
public class SemuaBukuTamu extends ListActivity {
    ...
    private static String url_semua_bukutamu = "http://10.0.2.2/Android-MySQL/pendaftaran/get_all_pendaftaran.php";
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ...
                            R.layout.list_pendaftaran, new String[] { TAG_PID, TAG_NAME, TAG_EMAIL},
                            new int[] { R.id.pid, R.id.name, R.id.email });
